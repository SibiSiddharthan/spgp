...
uint32_t ed25519ph_verify(ed25519_key *key, ed25519_signature *edsign, void *context, size_t context_size, void *message, size_t message_size)
{
	uint32_t status = 0;
	ec_group *group = NULL;
	...
	status = ed25519_verify_internal(group, key, edsign, context, context_size, message, message_size);
