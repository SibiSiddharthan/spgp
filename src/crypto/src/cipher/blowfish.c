...
static const uint32_t P[BLOWFISH_MAX_ROUNDS + 2] = {0x243F6A88, 0x85A308D3, 0x13198A2E, 0x03707344, 0xA4093822, 0x299F31D0,
...
static void blowfish_key_init_common(blowfish_key *expanded_key, byte_t *key, byte_t size)
{
	...
	// Copy Initial S-box data
	memcpy(expanded_key->sbox0, S0, sizeof(S0));
	memcpy(expanded_key->sbox1, S1, sizeof(S1));
	memcpy(expanded_key->sbox2, S2, sizeof(S2));
