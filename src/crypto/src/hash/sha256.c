...
// SHA-224
static uint32_t H224_0 = 0xC1059ED8;
static uint32_t H224_1 = 0x367CD507;
static uint32_t H224_2 = 0x3070DD17;
static uint32_t H224_3 = 0xF70E5939;
static uint32_t H224_4 = 0xFFC00B31;
static uint32_t H224_5 = 0x68581511;
static uint32_t H224_6 = 0x64F98FA7;
static uint32_t H224_7 = 0xBEFA4FA4;

// SHA-256
static uint32_t H256_0 = 0x6A09E667;
static uint32_t H256_1 = 0xBB67AE85;
static uint32_t H256_2 = 0x3C6EF372;
static uint32_t H256_3 = 0xA54FF53A;
static uint32_t H256_4 = 0x510E527F;
static uint32_t H256_5 = 0x9B05688C;
static uint32_t H256_6 = 0x1F83D9AB;
static uint32_t H256_7 = 0x5BE0CD19;
...
static void sha256_quick_reset(sha256_ctx *ctx)
{
	ctx->h0 = H256_0;
	ctx->h1 = H256_1;
	ctx->h2 = H256_2;
...
static void sha224_quick_reset(sha224_ctx *ctx)
{
	ctx->h0 = H224_0;
	ctx->h1 = H224_1;
	ctx->h2 = H224_2;
