...
int32_t twofish128_test_suite(void)
{
	...
	twofish_key *key = new_twofish_key(TWOFISH128, secret);
...
int32_t twofish192_test_suite(void)
{
	...
	twofish_key *key = new_twofish_key(TWOFISH192, secret);
...
int32_t twofish256_test_suite(void)
{
	...
	twofish_key *key = new_twofish_key(TWOFISH256, secret);
