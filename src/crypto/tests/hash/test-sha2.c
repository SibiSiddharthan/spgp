...
int32_t sha384_test_suite(void)
{
	...
	sha384_quick_hash("", 0, buffer);
	status += check_hash(buffer, SHA384_HASH_SIZE,
						 "38b060a751ac96384cd9327eb1b1e36a21fdb71114be07434c0cc7bf63f6e1da274edebfe76f65fbd51ad2f14898b95b");

	// ----------------------------------------------------------------------------------------------------------------

	sha384_quick_hash("abc", 3, buffer);
	status += check_hash(buffer, SHA384_HASH_SIZE,
						 "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7");

	// ----------------------------------------------------------------------------------------------------------------

	sha384_quick_hash("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq", 56, buffer);
	status += check_hash(buffer, SHA384_HASH_SIZE,
						 "3391fdddfc8dc7393707a65b1b4709397cf8b1d162af05abfe8f450de5f36bc6b0455a8520bc4e6f5fe95b1fe3c8452b");

	// ----------------------------------------------------------------------------------------------------------------

	sha384_quick_hash("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
					  112, buffer);
	status += check_hash(buffer, SHA384_HASH_SIZE,
...
int32_t sha512_test_suite(void)
{
	...
	sha512_quick_hash("abc", 3, buffer);
	status += check_hash(
		buffer, SHA512_HASH_SIZE,
	...
	sha512_quick_hash("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq", 56, buffer);
	status += check_hash(
		buffer, SHA512_HASH_SIZE,
	...
	sha512_quick_hash("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
					  112, buffer);
	status += check_hash(
		buffer, SHA512_HASH_SIZE,
