...
int32_t sha3_384_test_suite(void)
{
	...
	sha3_384_quick_hash("", 0, buffer);
	status += check_hash(buffer, SHA3_384_HASH_SIZE,
						 "0c63a75b845e4f7d01107d852e4c2485c51a50aaaa94fc61995e71bbee983a2ac3713831264adb47fb6bd1e058d5f004");

	// ----------------------------------------------------------------------------------------------------------------

	sha3_384_quick_hash("abc", 3, buffer);
	status += check_hash(buffer, SHA3_384_HASH_SIZE,
						 "ec01498288516fc926459f58e2c6ad8df9b473cb0fc08c2596da7cf0e49be4b298d88cea927ac7f539f1edf228376d25");

	// ----------------------------------------------------------------------------------------------------------------

	sha3_384_quick_hash("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq", 56, buffer);
	status += check_hash(buffer, SHA3_384_HASH_SIZE,
						 "991c665755eb3a4b6bbdfb75c78a492e8c56a22c5c4d7e429bfdbc32b9d4ad5aa04a1f076e62fea19eef51acd0657c22");

	// ----------------------------------------------------------------------------------------------------------------

	sha3_384_quick_hash("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
						112, buffer);
	status += check_hash(buffer, SHA3_384_HASH_SIZE,
...
int32_t sha3_512_test_suite(void)
{
	...
	sha3_512_quick_hash("abc", 3, buffer);
	status += check_hash(
		buffer, SHA3_512_HASH_SIZE,
	...
	sha3_512_quick_hash("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq", 56, buffer);
	status += check_hash(
		buffer, SHA3_512_HASH_SIZE,
	...
	sha3_512_quick_hash("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu",
						112, buffer);
	status += check_hash(
		buffer, SHA3_512_HASH_SIZE,
