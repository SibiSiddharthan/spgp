...
typedef enum _tls_cipher_suite
{
	...
	TLS_RSA_WITH_NULL_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x02),
	TLS_RSA_WITH_NULL_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0x3B),
	TLS_RSA_WITH_RC4_128_MD5 = TLS_MAKE_CIPHER_SUITE(0x00, 0x04),
	TLS_RSA_WITH_RC4_128_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x05),
	TLS_RSA_WITH_IDEA_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x07),
	TLS_RSA_WITH_DES_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x09),
	TLS_RSA_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x0A),
	TLS_RSA_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x2F),
	TLS_RSA_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x35),
	...
	TLS_DH_DSS_WITH_DES_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x0C),
	TLS_DH_DSS_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x0D),
	TLS_DH_RSA_WITH_DES_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x0F),
	TLS_DH_RSA_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x10),
	TLS_DHE_DSS_WITH_DES_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x12),
	TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x13),
	TLS_DHE_RSA_WITH_DES_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x15),
	TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x16),
	TLS_DH_DSS_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x30),
	TLS_DH_RSA_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x31),
	TLS_DHE_DSS_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x32),
	TLS_DHE_RSA_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x33),
	TLS_DH_DSS_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x36),
	TLS_DH_RSA_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x37),
	TLS_DHE_DSS_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x38),
	TLS_DHE_RSA_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x39),
	...
	TLS_DH_ANON_WITH_DES_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x1A),
	TLS_DH_ANON_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x1B),
	TLS_DH_ANON_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x34),
	TLS_DH_ANON_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x3A),
	...
	TLS_RSA_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0x9C),
	TLS_RSA_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0x9D),
	TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0x9E),
	TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0x9F),
	TLS_DH_RSA_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA0),
	TLS_DH_RSA_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA1),
	TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA2),
	TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA3),
	TLS_DH_DSS_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA4),
	TLS_DH_DSS_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA5),
	TLS_DH_anon_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA6),
	TLS_DH_anon_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA7),

	// RFC 5487: Pre-Shared Key Cipher Suites for TLS with SHA-256/384 and AES Galois Counter Mode
	TLS_PSK_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA8),
	TLS_PSK_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xA9),
	TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xAA),
	TLS_DHE_PSK_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xAB),
	TLS_RSA_PSK_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xAC),
	TLS_RSA_PSK_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xAD),

	TLS_PSK_WITH_AES_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xAE),
	TLS_PSK_WITH_AES_256_CBC_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xAF),
	TLS_PSK_WITH_NULL_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB0),
	TLS_PSK_WITH_NULL_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB1),

	TLS_DHE_PSK_WITH_AES_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB2),
	TLS_DHE_PSK_WITH_AES_256_CBC_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB3),
	TLS_DHE_PSK_WITH_NULL_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB4),
	TLS_DHE_PSK_WITH_NULL_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB5),

	TLS_RSA_PSK_WITH_AES_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB6),
	TLS_RSA_PSK_WITH_AES_256_CBC_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB7),
	TLS_RSA_PSK_WITH_NULL_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB8),
	TLS_RSA_PSK_WITH_NULL_SHA384 = TLS_MAKE_CIPHER_SUITE(0x00, 0xB9),

	// RFC 5932:  Camellia Cipher Suites for TLS
	TLS_RSA_WITH_CAMELLIA_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x41),
	TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x42),
	TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x43),
	TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x44),
	TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x45),
	TLS_DH_ANON_WITH_CAMELLIA_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x46),

	TLS_RSA_WITH_CAMELLIA_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x84),
	TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x85),
	TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x86),
	TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x87),
	TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x88),
	TLS_DH_ANON_WITH_CAMELLIA_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0x00, 0x89),

	TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xBA),
	TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xBB),
	TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xBC),
	TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xBD),
	TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xBE),
	TLS_DH_ANON_WITH_CAMELLIA_128_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xBF),

	TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xC0),
	TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xC1),
	TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xC2),
	TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xC3),
	TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xC4),
	TLS_DH_ANON_WITH_CAMELLIA_256_CBC_SHA256 = TLS_MAKE_CIPHER_SUITE(0x00, 0xC5),
	...
	TLS_ECDHE_ECDSA_WITH_NULL_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x06),
	TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x08),
	TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x09),
	TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x0A),

	TLS_ECDHE_RSA_WITH_NULL_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x10),
	TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x12),
	TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x13),
	TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x14),

	TLS_ECDH_ANON_WITH_NULL_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x15),
	TLS_ECDH_ANON_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x17),
	TLS_ECDH_ANON_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x18),
	TLS_ECDH_ANON_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x19),

	// RFC 5054: Using the Secure Remote Password (SRP) Protocol for TLS Authentication
	TLS_SRP_SHA_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x1A),
	TLS_SRP_SHA_RSA_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x1B),
	TLS_SRP_SHA_DSS_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x1C),
	TLS_SRP_SHA_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x1D),
	TLS_SRP_SHA_RSA_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x1E),
	TLS_SRP_SHA_DSS_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x1F),
	TLS_SRP_SHA_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x20),
	TLS_SRP_SHA_RSA_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x21),
	TLS_SRP_SHA_DSS_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x22),
	...
	TLS_ECDHE_PSK_WITH_RC4_128_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x33),
	TLS_ECDHE_PSK_WITH_3DES_EDE_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x34),
	TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x35),
	TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x36),
	...
	TLS_ECDHE_PSK_WITH_NULL_SHA1 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x39),
	...
	TLS_PSK_WITH_CAMELLIA_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0xC0, 0x8E),
	...
	TLS_SHA256_SHA256 = TLS_MAKE_CIPHER_SUITE(0xC0, 0xB4),
	TLS_SHA384_SHA384 = TLS_MAKE_CIPHER_SUITE(0xC0, 0xB5),
	...
	TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0xD0, 0x01),
	TLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384 = TLS_MAKE_CIPHER_SUITE(0xD0, 0x02),
	TLS_ECDHE_PSK_WITH_AES_128_CCM_8_SHA256 = TLS_MAKE_CIPHER_SUITE(0xD0, 0x03),
	TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256 = TLS_MAKE_CIPHER_SUITE(0xD0, 0x05),
