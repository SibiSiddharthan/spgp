...
typedef enum _tls_cipher_suite
{
	...
	TLS_RSA_WITH_CAMELLIA_128_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x41),
	TLS_DH_DSS_WITH_CAMELLIA_128_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x42),
	TLS_DH_RSA_WITH_CAMELLIA_128_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x43),
	TLS_DHE_DSS_WITH_CAMELLIA_128_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x44),
	TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x45),
	TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x46),

	TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x84),
	TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x85),
	TLS_DH_RSA_WITH_CAMELLIA_256_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x86),
	TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x87),
	TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x88),
	TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA = TLS_MAKE_CIPHER_SUITE(0x00, 0x89),
