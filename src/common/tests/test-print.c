...
uint32_t test_int(void)
{
	...
	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%2d", -55);
	status += CHECK_STRING(buffer, "-55");
	status += CHECK_RESULT(result, 3);
	...
	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%+02d", 55);
	status += CHECK_STRING(buffer, "+55");
	status += CHECK_RESULT(result, 3);
...
uint32_t test_uint(void)
{
	...
	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%-7.5u", 55);
	status += CHECK_STRING(buffer, "00055  ");
	status += CHECK_RESULT(result, 7);

	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%8.5u", 55);
	status += CHECK_STRING(buffer, "   00055");
	status += CHECK_RESULT(result, 8);

	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%8.1u", 55);
	status += CHECK_STRING(buffer, "      55");
	status += CHECK_RESULT(result, 8);

	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%#2.5u", 55);
	status += CHECK_STRING(buffer, "00055");
	status += CHECK_RESULT(result, 5);
	...
	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%#05o", 55);
	...
	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%#.5o", 55);
	...
	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%x %x", 10, 100);
	...
	memset(buffer, 0, 256);
	result = sprint(buffer, 256, "%.3x", 55);
