...
pgp_error_t pgp_generate_certificate_signature(pgp_key_packet *key, byte_t version, byte_t type, pgp_hash_algorithms hash_algorithm,
											   uint32_t timestamp, uint32_t expiry, key_preferences *preferences, void *user);
